...
import { ObjectViewPayloadRenderer, PayloadRendererProps } from './surface-payload'
...
import { SurfaceBoardPayload_Info, SurfaceBoardPayload_InputView_Props } from './surface-board-payload-info'
import { ImportMetaEnv } from '../../../infra'
import { usePayloadActionButtons, UsePayloadActionButtons_Input } from './use-payload-action-buttons'
    ...
    const id = useId()
        ...
        , _add_Payloads_Async = async ({
            ...
            & {
                trigger:
                KeyOf<
                    & Pick<SurfaceBoardPayload_InputView_Props<P>, "onDone">
                    & Pick<SurfaceBoardPayload_Info<P>, "factory">
                >
            }
        ) => {
        ...
        } as ExtractEventHandlersMap<SurfaceBoardPayload_InputView_Props<P>>
