...
import { EventHandlersFromMap, HasEventHandler, HasName, HasPartialEventHandler, HasPartialName, KeyOf, PartialEventHandlersFromMap, XOR } from "@ns-world-lab-kxn/types"
